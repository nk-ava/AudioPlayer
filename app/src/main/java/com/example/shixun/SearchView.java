...
public class SearchView extends LinearLayout {
    ...
    private ScrollView scrollView; // 历史记录布局控件
    ...
    private void initView(){
        ...
        // 7. ScrollView控件
        scrollView = (ScrollView) findViewById(R.id.searchLayout_scrollView);
    }
    ...
    private void queryData(String tempName) {
        ...
        if (tempName.equals("") && cursor.getCount() != 0){
            tv_clear.setText("删除搜索记录");
        }
        else {
            tv_clear.setText("暂无搜索记录");
        };
    ...
    /**
     * 获取ScrollView控件的方法，用于动态设置历史记录的高度
     */
    public ScrollView getHistoryLayout(){
     ...
     * 设置搜索框清空按钮的回调方法
     */
    public void setEditClearListener(Clear_opt clear){
        et_search.setClearOpt(clear);
    }
}
